...
env.hosts = ['XenithOrg.example.com']
env.code_dir = '/srv/www/XenithOrg'
env.virtualenv = '/srv/www/XenithOrg/.virtualenv'
env.code_repo = 'git@github.com:user/XenithOrg.git'
...
def restart():
    ...
    with cd(env.code_dir):
        run("touch %s/XenithOrg/wsgi.py" % env.code_dir)
