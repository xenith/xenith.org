...
DEBUG_TOOLBAR_CONFIG = {
    ...
    'SHOW_TOOLBAR_CALLBACK': 'xenith.settings.base.custom_show_toolbar',
...
ADMINS = (
    ('Justin Seabrook-Rocha', 'xenith@xenith.org'),
)
MANAGERS = ADMINS
...
SERVER_EMAIL = "webmaster@xenith.org"
DEFAULT_FROM_EMAIL = "webmaster@xenith.org"
SYSTEM_EMAIL_PREFIX = "[Xenith.org]"

## Log settings

LOG_LEVEL = logging.INFO
HAS_SYSLOG = True
SYSLOG_TAG = "http_app_xenith"  # Make this unique to your project.
